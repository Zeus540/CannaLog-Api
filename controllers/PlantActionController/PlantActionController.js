...
module.exports = {
  ...
  getActionDataByType: (req, res) => {
    ...
    */
    ...
    switch (req.params.type) {
      case "14":
        sql = `
        SELECT plant_stages.plant_stage,plant_stages.user_id, plant_stages.plant_id,plant_stages.plant_stage_id,stages.stage_name,plant_stages.plant_action_id,plant_stages.creation_date,stages.stage_color
        FROM plant_stages
  ...
  takeAction: (req, res) => {
    ...
    console.log(req.body.plant_action_type_id == 14)
